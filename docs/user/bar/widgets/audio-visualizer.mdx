...
Horizontal audio spectrum using the current PipeWire monitor stream. Its frequency range comes from the shared
[`[audio.spectrum]` settings](/noctalia/services/audio/) and therefore also applies to desktop and plugin consumers.
