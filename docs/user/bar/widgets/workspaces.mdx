...
| `monitors` | list of strings | `[]` | Connector names whose workspaces are shown. Leave empty or omit to show workspaces only from the monitor hosting this bar. |
...
monitors = []           # connector names whose workspaces are shown, e.g. "DP-1"
pill_scale = 1.0
