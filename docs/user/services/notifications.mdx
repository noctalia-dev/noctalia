...
width                    = 360         # toast width in pixels before scaling (240–500)
...
- `width = 360` (default) toast width in pixels before `scale` (`240`–`500`). Configure in **Settings → Notifications → Toasts**.
