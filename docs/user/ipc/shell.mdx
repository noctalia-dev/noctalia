...
- **Quick tap** - releasing Alt/Super before the overlay has keyboard focus counts as the release: the previous window is activated and the overlay closes, like a quick Alt+Tab
