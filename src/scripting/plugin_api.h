...
namespace scripting {
  ...
  inline constexpr std::uint32_t kCalendarEventsPluginApiVersion = 33;
  inline constexpr std::uint32_t kCurrentPluginApiVersion = kCalendarEventsPluginApiVersion;
