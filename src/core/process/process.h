...
namespace process {
  ...
  // Interruptible shell run: honors options.timeout and options.cancel, killing the
  // child's process group when either fires (used for template hooks so a hung hook
